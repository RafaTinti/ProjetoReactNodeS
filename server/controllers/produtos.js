...
export const validaArquivo = (req, res) => {
    try {
                        ...
                        if(entry[0].id){
                            ...
                            const somaComposicaoNovo = composicao.reduce((accumulator, element) => {
                                if (!element.new_priceObj){// se nao tem preco novo para produto do pacote
                                    temp.erro += `Novo preço para produto codigo ${element.code} não informado. `;
                                    temp.valido = false;
                                    return -10000000000;
                                }
        ...
        // const tabelaPrecosNovos = req.body;
        // const listaModificacao = [];
        // tabelaPrecosNovos.forEach(e => {
        //     //objeto que sera mandando de volta para o client
        //     temp = {
        //         codigo: e.product_code, 
        //         nome: null, 
        //         preco_atual: null,
        //         preco_novo: e.product_price,
        //         erro: "",
        //         valido: false,
        //     }

        //     //verifica se os campos estao preenchidos
        //     if (!e.product_code || !e.product_price){
        //         temp.erro = "Campos não preenchidos";
        //         temp.valido =false;
        //         listaModificacao.push(temp);
        //         return;
        ...
        //     //verifica se preco novo e valido
        //     if (isNaN(Number(e.product_price))){
        //         temp.erro = "Preço informado inválido";
        //         temp.valido =false;
        //         listaModificacao.push(temp);
        //         return;
